...
A LambdaBetterGrass fork that replaces textures of dirt according to blocks above it.

Result is green, beautiful landscapes and mountains snowier than ever before.

This fork only modifies behavior of dirt, grass block, and snowy grass block.

All other blocks are working the same way as in original mod.

Huge thanks to LambdAurora for help with this creation.

![Wise words](https://i.ibb.co/BtGdgqS/image.png)

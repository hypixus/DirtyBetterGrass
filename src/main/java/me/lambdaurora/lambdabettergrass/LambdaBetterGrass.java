...
import static me.lambdaurora.lambdabettergrass.util.HypixusUtil.shouldBeTinted;
...
public class LambdaBetterGrass implements ClientModInitializer {
    ...
    public static final Identifier BETTER_GRASS_SIDE_SNOWY_MASK = mc("bettergrass/mask/standard_block_side_connect.png");
    ...
    public void onInitializeClient() {
        ...
        ColorProviderRegistry.BLOCK.register((state, world, pos, tintIndex) -> shouldBeTinted(world, pos) ? (world != null && pos != null ? BiomeColors.getGrassColor(world, pos) : GrassColors.getColor(0.5D, 1.0D)) : -1, Blocks.DIRT);
